/**
 * Copied from experiments/013-vocabulary/review/shoot.mjs so the score harness
 * can point it at any deck dir. Only ROOT and OUT differ.
 *
...
const ROOT = resolve(process.cwd(), deckDir);
const OUT = process.env.SHOTS ?? join(HERE, "shots");
